...
function generateAgentContent() {
    ...
    if (currentAgent === 'marketing') {
        ...
        // Update image recommendation dynamically
        ...
        if (adImage && adImageDesc) {
            adImage.src = tpl.image;
            adImageDesc.innerText = `קובץ התמונה שמור בתיקיית העסק שלך תחת השם: ${tpl.image}`;
        }
    } else {
